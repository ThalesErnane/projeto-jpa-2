...
@Entity
@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE) // informar a estratégia q o cache ira usar
public class Produto {
	...
	@ManyToMany
	@JoinTable(name="CATEGORIA_PRODUTO") // da o nome para a tabela de relacionamento
